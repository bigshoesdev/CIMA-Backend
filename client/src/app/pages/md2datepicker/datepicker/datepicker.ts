...
export class MdDatepicker implements AfterContentInit, ControlValueAccessor {
  ...
  set value(value: any) {
    if (value && value !== this._value) {
      ...
      let date = '';
      if (this.type !== 'time') {
        date += this._value.getFullYear() + '-' + (((this._value.getMonth() + 1) < 10) ? ("0" + (this._value.getMonth() + 1)) : (this._value.getMonth() + 1)) + '-' + (((this._value.getDate()) < 10) ? ("0" + (this._value.getDate())) : (this._value.getDate()));
        date = new Date(date).toDateString().split(" ")[2] + " " + new Date(date).toDateString().split(" ")[1] + " " + new Date(date).toDateString().split(" ")[3];
      }
  ...
  private _formatDate(date: Date): string {
    ...
    var temp = new Date(date).toDateString().split(" ")[2] + " " + new Date(date).toDateString().split(" ")[1] + " " + new Date(date).toDateString().split(" ")[3];
    // return this.format
  ...
  writeValue(value: any): void {
    if (value && value !== this._value) {
      ...
      if (this.type !== 'time') {
        date += this._value.getFullYear() + '-' + (((this._value.getMonth() + 1) < 10) ? ("0" + (this._value.getMonth() + 1)) : (this._value.getMonth() + 1)) + '-' + this._value.getDate();
      }
      if (this.type === 'datetime') {
        date += ' ';
      }
